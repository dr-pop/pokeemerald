...
static const u32 sNewGameBirch_Gfx[] = INCBIN_U32("graphics/birch_speech/buxus.4bpp"); //INCBIN_U32("graphics/birch_speech/birch.4bpp");
static const u32 sUnusedBirchBeauty[] = INCBIN_U32("graphics/unused/intro_birch_beauty.4bpp");
static const u16 sNewGameBirch_Pal[16] = INCBIN_U16("graphics/birch_speech/buxus.gbapal"); //INCBIN_U16("graphics/birch_speech/birch.gbapal");
