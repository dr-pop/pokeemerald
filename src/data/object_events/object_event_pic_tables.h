...
const struct SpriteFrameImage gObjectEventPicTable_PopPlayerM_Normal[] = { //custom
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 0),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 1),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 2),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 3),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 4),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 5),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 6),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 7),
    overworld_frame(gObjectEventPic_PopPlayerM_Normal, 2, 4, 8),
};