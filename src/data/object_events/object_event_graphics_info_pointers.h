...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_PopPlayerM_Normal; // custom
...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[NUM_OBJ_EVENT_GFX] = {
	...
	[OBJ_EVENT_GFX_POPPLAYERM_NORMAL] =        &gObjectEventGraphicsInfo_PopPlayerM_Normal, // custom
};
